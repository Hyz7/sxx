...
export default class Fade extends Component {
    ...
    render() {
        ...
        const transitionStyles = {
            entering: { transform: 'translateX(100px)', opacity: '0',transition:'all 500ms'},
            entered:  { transform: 'translateX(0px)', opacity: '1',transition:'all 500ms' },
            exiting: {transform: 'translateX(0px)', opacity: '1',transition:'all 500ms'},
            exited: {transform: 'translateX(0px)', opacity: '0',transition:'all 500ms'}
        };
        const duration = {
            enter: 300,
            exit: 300,
